...
function ProductOptions({ product }) {
  ...
  return (
    <form className="w-full p-2 tablet:w-[70%] tablet:mx-auto laptop:mx-0 laptop:p-0 laptop:mt-4 laptop:w-full">
      <div className="flex items-center gap-1 mb-4 bg-zinc-200 w-fit px-2 py-1.5 laptop:px-3 laptop:cursor-pointer hover:bg-zinc-300 transition-all duration-200">
        <img
        ...
        />
        <p
          className=" text-zinc-800 text-sm tablet:text-[24px] laptop:text-lg"
