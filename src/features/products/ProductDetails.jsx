...
function ProductDetails({ product }) {
  ...
  return (
    <div className="p-2 text-md flex flex-col gap-4 text-zinc-800 tablet:text-lg tablet:w-[70%] tablet:mx-auto laptop:w-full laptop:flex-row desktop:border desktop:border-zinc-200 desktop:rounded-2xl desktop:py-20">
      ...
      <img
        src={image}
        alt="product image"
        className="w-50 h-50 shadow mx-auto tablet:w-60 tablet:h-60 laptop:w-84 laptop:h-84"
      />
      <div className="laptop:mx-auto">
        <div className="w-full flex flex-col gap-4 laptop:gap-8 laptop:items-start">
          ...
          <p className="text-lg tablet:mx-auto">{description}</p>
        </div>
