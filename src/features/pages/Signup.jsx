...
function Signup() {
  ...
  return (
    <div className="tablet:bg-zinc-100 laptop:flex desktop:mx-auto desktop:bg-zinc-800 ">
      <section className="w-full h-screen p-2 bg-zinc-100 flex flex-col justify-center gap-6 items-center tablet:w-[500px] tablet:mx-auto desktop:w-[60%]">
        <form
          action=""
      ...
      <section className="hidden w-[45%] h-screen bg-zinc-800 justify-center items-end laptop:flex">
        <img
          src="./accessory-shopping-cart.png"
          alt=""
