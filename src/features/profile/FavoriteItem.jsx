function FavoriteItem({ product }) {
  return (
    <li className="bg-zinc-50 flex flex-col w-26 h-fit tablet:w-32 laptop:w-36 desktop:w-48 gap-4 laptop:gap-4 desktop:gap-4 shadow p-2 rounded-xl tablet:p-3 laptop:cursor-pointer">
      <img
        src=""
        alt="productImage"
