...
function ProfileSidebarItem({ item }) {
  ...
  return (
    <Link
      ...
      className={`w-full flex items-center gap-2 pl-1 mb-2 p-2 laptop:text-lg rounded-lg text-zinc-700 laptop:hover:bg-zinc-300 transition-all duration-200 laptop:cursor-pointer ${
