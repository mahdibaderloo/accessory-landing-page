...
function Notification() {
  ...
  return (
    <div className="w-full laptop:w-[70%] p-4 laptop:p-0 laptop:m-8">
      <Link
        to={-1}
        className="text-center rounded-md font-barlow bg-zinc-500 hover:bg-zinc-800 text-zinc-100 transition-all duration-200 laptop:rounded-xl py-2 px-3 laptop:py-2 laptop:leading-[40px] desktop:mr-87"
      >
        &larr; Back
      </Link>
      <div className="flex flex-col gap-6 mt-8 bg-zinc-50 h-fit p-4 rounded-lg laptop:rounded-2xl shadow">
        ...
        <div
          className="text-zinc-700 text-lg font-medium mb-8 flex"
