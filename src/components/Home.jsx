function Home() {
  return (
    <main>
      <section className="bg-gradient-to-r from-zinc-900 via-zinc-500 to-zinc-800 mx-3.5 mt-12 rounded-3xl relative">
        <img src="./main-image.png" alt="main" className="" />
        <div className="hidden absolute w-80 top-[20%] right-5  laptop:flex flex-col flex-wrap desktop:right-20 desktop:w-96">
          <h1 className=" text-5xl font-bold text-zinc-200">Accessory</h1>
