        ...
        <div className="w-full h-screen absolute top-0 left-0 flex justify-center items-center">
          <div className="shadow-lg bg-zinc-100 w-[50%] p-4 flex flex-col rounded-2xl">
            ...
            <div className="flex justify-center gap-3 mt-4">
              <button
                className="bg-emerald-600 hover:bg-emerald-700 transition-all duration-200 shadow text-zinc-50 px-3 py-1 rounded-md cursor-pointer"
                onClick={() => {
              ...
              <button
                className="bg-red-600 hover:bg-red-700 transition-all duration-200 shadow text-zinc-50 px-3 py-1 rounded-md cursor-pointer"
                onClick={() => dispatch(closeModal())}
              >
                No
              </button>
